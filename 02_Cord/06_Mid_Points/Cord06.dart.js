...
$$.Cord06 = {"":
 ...
 moveParticles$0: function() {
  ...
  for (; c > min; --c) {
    ...
    if (t1) t2.moveTo$2(p.get$x(), p.get$y());
      ...
      this.context.lineTo$2(p.get$midPointX(), p.get$midPointY());
    }
  ...
  for (; c > min; --c) {
    ...
    if (t1) t2.moveTo$2(p.get$x(), p.get$y());
      ...
      t2.moveTo$2(p.get$midPointX(), p.get$midPointY());
      this.context.lineTo$2($.add(p.get$midPointX(), 0.5), p.get$midPointY());
    }
    this.context.set$lineJoin('round');
    this.context.set$lineCap('round');
 ...
 run$0: function() {
  ...
  $.window().setInterval$2(new $.Cord06_run_f(this), $.toInt(100.0));
  $.window().setInterval$2(new $.Cord06_run_f0(this), $.toInt(33.333333333333336));
 }
};
...
$.Cord06$ = function() {
  return new $.Cord06(null, 600, 0.97, 1, 300, 25, null, null, null, null, null, null, null);
};

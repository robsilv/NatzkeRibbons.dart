...
//  ********** Library C:\Users\Rob\Natzke Ribbons\02_Cord\06_Cord\Cord06 **************
// ********** Code for Cord06 **************
function Cord06() {
...
Cord06.prototype.onDocumentMouseMove = function(event) {
  this.mouseX = event.get$pageX();
  this.mouseY = event.get$pageY();
}
Cord06.prototype.get$onDocumentMouseMove = function() {
  return this.onDocumentMouseMove.bind(this);
}
Cord06.prototype.spawnParticle = function() {
...
Cord06.prototype.moveParticles = function() {
  ...
  for (var c = this.particleNum - (1);
   c > min; c--) {
    ...
    if (c == this.particleNum - (1)) {
      ...
      this.context.lineTo(p.midPointX, p.midPointY);
    }
  ...
  for (var c = this.particleNum - (1);
   c > min; c--) {
    ...
    if (c == this.particleNum - (1)) {
      ...
      this.context.lineTo(p.midPointX + (0.5), p.midPointY);
    }
    this.context.set$lineJoin("round");
    this.context.set$lineCap("round");

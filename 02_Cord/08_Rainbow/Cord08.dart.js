...
$$.Cord08 = {"":
 ...
 moveParticles$0: function() {
  ...
  for (; c > min; --c) {
    ...
    var radStr = $.toRadixString($.toInt($.mul($.Math_random(), 16777215)), 16);
 ...
 run$0: function() {
  ...
  $.window().setInterval$2(new $.Cord08_run_f(this), $.toInt(100.0));
  $.window().setInterval$2(new $.Cord08_run_f0(this), $.toInt(33.333333333333336));
 }
};
...
$.Cord08$ = function() {
  return new $.Cord08(null, 600, 0.97, 0.5, 300, 25, null, null, null, null, null, null, null);
};

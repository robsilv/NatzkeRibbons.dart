...
//  ********** Library C:\Users\Rob\Natzke Ribbons\02_Cord\08_Cord\Cord08 **************
// ********** Code for Cord08 **************
function Cord08() {
...
Cord08.prototype.onDocumentMouseMove = function(event) {
  this.mouseX = event.get$pageX();
  this.mouseY = event.get$pageY();
}
Cord08.prototype.get$onDocumentMouseMove = function() {
  return this.onDocumentMouseMove.bind(this);
}
Cord08.prototype.spawnParticle = function() {
...
Cord08.prototype.moveParticles = function() {
  ...
  for (var c = this.particleNum - (1);
   c > min; c--) {
    ...
    var radStr = (Math.random() * (16777215)).toInt().toRadixString((16));
    this.context.set$strokeStyle(radStr);
    this.context.stroke();
  }
  for (var c = this.particleNum - (1);
   c > min; c--) {

...
//  ********** Library C:\Users\Rob\Natzke Ribbons\02_Cord\01_Simple_Cord\Cord01 **************
// ********** Code for Cord01 **************
function Cord01() {
...
Cord01.prototype.onDocumentMouseMove = function(event) {
  this.mouseX = event.get$pageX();
  this.mouseY = event.get$pageY();
}
Cord01.prototype.get$onDocumentMouseMove = function() {
  return this.onDocumentMouseMove.bind(this);
}
Cord01.prototype.spawnParticle = function() {
  this.particleNum++;
...
Cord01.prototype.moveParticles = function() {

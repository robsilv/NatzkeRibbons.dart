...
$$.Cord01 = {"":
 ...
 moveParticles$0: function() {
  ...
  for (t1 = $.iterator(this.particles.getKeys$0()); t1.hasNext$0() === true; ) {
    t2 = t1.next$0();
    p = $.index(this.particles, t2);
 ...
 run$0: function() {
  ...
  $.window().setInterval$2(new $.Cord01_run_f(this), $.toInt(200.0));
  $.window().setInterval$2(new $.Cord01_run_f0(this), $.toInt(33.333333333333336));
 }
};
...
$.Cord01$ = function() {
  return new $.Cord01(null, 600, 0.97, 1, 250, null, null, null, null, null, null, null);
};
...
$.Particle$ = function(x, y, xSpeed, ySpeed) {
  return new $.Particle(ySpeed, xSpeed, y, x);
};

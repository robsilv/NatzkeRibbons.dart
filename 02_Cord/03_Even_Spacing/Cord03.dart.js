...
//  ********** Library C:\Users\Rob\Natzke Ribbons\02_Cord\03_Cord\Cord03 **************
// ********** Code for Cord03 **************
function Cord03() {
...
Cord03.prototype.onDocumentMouseMove = function(event) {
  this.mouseX = event.get$pageX();
  this.mouseY = event.get$pageY();
}
Cord03.prototype.get$onDocumentMouseMove = function() {
  return this.onDocumentMouseMove.bind(this);
}
Cord03.prototype.spawnParticle = function() {
  var mag = Math.random() * (10);
  var dir = Math.random() * (3.141593) * (2);
  this.particles.$setindex(("p " + this.particleNum), new Particle(this.mouseX, this.mouseY, Math.cos(dir) * mag, Math.sin(dir) * mag));
...
Cord03.prototype.moveParticles = function() {

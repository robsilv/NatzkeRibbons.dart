...
$$.Cord03 = {"":
 ...
 moveParticles$0$bailout: function(state, env0, env1) {
  ...
  switch (state) {
    ...
    case 3:
      ...
      for (; $.gtB(c, min); c = $.sub(c, 1)) {
        p = $.index(this.particles, 'p ' + $.S(c));
        $.index(this.particles, 'p ' + $.S($.sub(c, 1)));
 ...
 run$0: function() {
  ...
  $.window().setInterval$2(new $.Cord03_run_f(this), $.toInt(100.0));
  $.window().setInterval$2(new $.Cord03_run_f0(this), $.toInt(33.333333333333336));
 }
};
...
$.Cord03$ = function() {
  return new $.Cord03(null, 600, 0.97, 1, 100, 18, null, null, null, null, null, null, null);
};

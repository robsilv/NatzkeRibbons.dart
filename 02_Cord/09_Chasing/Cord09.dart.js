...
$$.Cord09 = {"":
 ...
 moveParticles$0: function() {
  ...
  for (; c > min; --c) {
    ...
    if ($.gtB(Distance, t6)) {
      ...
      p.set$xSpeed($.add(p.get$xSpeed(), $.mul($.sub(p.get$x(), oldX), 0.05)));
      p.set$ySpeed($.add(p.get$ySpeed(), $.mul($.sub(p.get$y(), oldY), 0.05)));
    }
 ...
 run$0: function() {
  ...
  $.window().setInterval$2(new $.Cord09_run_f(this), $.toInt(100.0));
  $.window().setInterval$2(new $.Cord09_run_f0(this), $.toInt(33.333333333333336));
 }
};
...
$.Cord09$ = function() {
  return new $.Cord09(null, 600, 0.97, 0.5, 100, 25, null, null, null, null, null, null, null);
};

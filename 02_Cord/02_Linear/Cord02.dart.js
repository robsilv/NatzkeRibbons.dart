...
$$.Cord02 = {"":
 ["wind", "ground", "airFriction", "gravity", "maxParticles", "particleNum", "particles", "mouseY", "mouseX", "context", "canvas", "container"],
 super: "Object",
 moveParticles$0: function() {
  this.context.clearRect$4(0, 0, this.canvas.get$width(), this.canvas.get$height());
  for (var t1 = $.iterator(this.particles.getKeys$0()), t2 = this.gravity, t3 = this.airFriction, t4 = this.ground; t1.hasNext$0() === true; ) {
    var t5 = t1.next$0();
    var p = $.index(this.particles, t5);
    ...
    this.context.arc$6(p.get$x(), p.get$y(), 10, 0, 6.283185307179586, false);
    this.context.closePath$0();
    this.context.fill$0();
    this.context.set$fillStyle('rgba( 50, 50, 50, 1 )');
    this.context.beginPath$0();
    this.context.arc$6(p.get$x(), p.get$y(), 8, 0, 6.283185307179586, false);
    this.context.closePath$0();
    this.context.fill$0();
  }
  this.context.beginPath$0();
  ...
  for (; c >= t2; --c) {
    ...
    t3 = this.context;
    if (t1) t3.moveTo$2(p.get$x(), p.get$y());
    else t3.lineTo$2(p.get$x(), p.get$y());
  }
 ...
 spawnParticle$0: function() {
  ...
  $.indexSet(this.particles, 'p ' + $.S(this.particleNum), $.Particle$(this.mouseX, this.mouseY, $.mul($.Math_cos(dir), mag), $.mul($.Math_sin(dir), mag)));
 ...
 run$0: function() {
  ...
  $.window().setInterval$2(new $.Cord02_run_f(this), $.toInt(200.0));
  $.window().setInterval$2(new $.Cord02_run_f0(this), $.toInt(33.333333333333336));
 }
};

$$.Particle = {"":
 ["midPointY", "midPointX", "ySpeed=", "xSpeed=", "y=", "x="],
 super: "Object"
};
...
$.Particle$ = function(x, y, xSpeed, ySpeed) {
  return new $.Particle(null, null, ySpeed, xSpeed, y, x);
};
...
$.Cord02$ = function() {
  return new $.Cord02(null, 600, 0.97, 1, 50, null, null, null, null, null, null, null);
};

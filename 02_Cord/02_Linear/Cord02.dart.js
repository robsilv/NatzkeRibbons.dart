...
//  ********** Library C:\Users\Rob\Natzke Ribbons\02_Cord\02_Cord\Cord02 **************
// ********** Code for Cord02 **************
function Cord02() {
...
Cord02.prototype.onDocumentMouseMove = function(event) {
  this.mouseX = event.get$pageX();
  this.mouseY = event.get$pageY();
}
Cord02.prototype.get$onDocumentMouseMove = function() {
  return this.onDocumentMouseMove.bind(this);
}
Cord02.prototype.spawnParticle = function() {
...
Cord02.prototype.moveParticles = function() {
  ...
  for (var $$i = $$list.iterator(); $$i.hasNext(); ) {
    ...
    this.context.arc(p.x, p.y, (10), (0), (6.283185), false);
    this.context.closePath();
    this.context.fill();
    this.context.set$fillStyle("rgba( 50, 50, 50, 1 )");
    this.context.beginPath();
    this.context.arc(p.x, p.y, (8), (0), (6.283185), false);
    this.context.closePath();
    this.context.fill();
  }
  this.context.beginPath();

...
//  ********** Library C:\Users\Rob\Natzke Ribbons\01_Particle\08_Random_Wind\ParticleEmitter08 **************
// ********** Code for ParticleEmitter08 **************
function ParticleEmitter08() {
  this.maxParticles = (150);
  this.gravity = (1);
  this.airFriction = (0.95);
  this.ground = (600);
}
ParticleEmitter08.prototype.run = function() {
  var $this = this; // closure support
  this.wind = (1);
  this.mouseX = (0);
  this.mouseY = (0);
...
ParticleEmitter08.prototype.onDocumentMouseMove = function(event) {
  this.mouseX = event.get$pageX();
  this.mouseY = event.get$pageY();
}
ParticleEmitter08.prototype.get$onDocumentMouseMove = function() {
  return this.onDocumentMouseMove.bind(this);
}
ParticleEmitter08.prototype.spawnParticle = function() {
  this.particleNum++;
  this.particles.$setindex(("p " + this.particleNum), new Particle(this.mouseX, this.mouseY, Math.random() * (4) - (2), Math.random() * (4) - (2)));
...
ParticleEmitter08.prototype.moveParticles = function() {
  this.context.clearRect((0), (0), this.canvas.get$width(), this.canvas.get$height());
  if (Math.random() < (0.05)) this.wind = Math.random() * (2) - (1);
...
(function(){
  ...
  var v8/*EventTarget*/ = [v2/*AbstractWorker*/,v3/*Node*/,'EventTarget|DOMApplicationCache|DOMWindow|EventSource|MessagePort|Notification|SVGElementInstance|WebSocket|XMLHttpRequest|XMLHttpRequestUpload'].join('|');
  var v9/*HTMLCollection*/ = 'HTMLCollection|HTMLOptionsCollection';
  var v10/*IDBRequest*/ = 'IDBRequest|IDBVersionChangeRequest';
  var v11/*MediaStream*/ = 'MediaStream|LocalMediaStream';

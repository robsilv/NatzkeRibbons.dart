...
$$.ParticleEmitter08 = {"":
 ...
 moveParticles$0: function() {
  ...
  if ($.ltB($.Math_random(), 0.05)) this.wind = $.sub($.mul($.Math_random(), 2), 1);
 ...
 spawnParticle$0: function() {
  ...
  $.indexSet(this.particles, 'p ' + $.S(this.particleNum), $.Particle$(this.mouseX, this.mouseY, $.sub($.mul($.Math_random(), 4), 2), $.sub($.mul($.Math_random(), 4), 2)));
 ...
 run$0: function() {
  ...
  $.window().setInterval$2(new $.ParticleEmitter08_run_f(this), 20);
  $.window().setInterval$2(new $.ParticleEmitter08_run_f0(this), 20);
 }
};
...
$.ParticleEmitter08$ = function() {
  return new $.ParticleEmitter08(null, 600, 0.95, 1, 150, null, null, null, null, null, null, null);
};

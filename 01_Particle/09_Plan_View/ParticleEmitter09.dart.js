...
//  ********** Library C:\Users\Rob\Natzke Ribbons\01_Particle\09_Plan_View\ParticleEmitter09 **************
// ********** Code for ParticleEmitter09 **************
function ParticleEmitter09() {
  this.maxParticles = (250);
  this.gravity = (0);
  this.airFriction = (0.97);
  this.ground = (600);
}
ParticleEmitter09.prototype.run = function() {
  var $this = this; // closure support
  this.wind = (0);
  this.mouseX = (0);
  this.mouseY = (0);
...
ParticleEmitter09.prototype.onDocumentMouseMove = function(event) {
  this.mouseX = event.get$pageX();
  this.mouseY = event.get$pageY();
}
ParticleEmitter09.prototype.get$onDocumentMouseMove = function() {
  return this.onDocumentMouseMove.bind(this);
}
ParticleEmitter09.prototype.spawnParticle = function() {
  this.particleNum++;
...
ParticleEmitter09.prototype.moveParticles = function() {

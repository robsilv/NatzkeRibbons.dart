...
$$.ParticleEmitter09 = {"":
 ...
 run$0: function() {
  ...
  $.window().setInterval$2(new $.ParticleEmitter09_run_f(this), 20);
  $.window().setInterval$2(new $.ParticleEmitter09_run_f0(this), 20);
 }
};
...
$.ParticleEmitter09$ = function() {
  return new $.ParticleEmitter09(null, 600, 0.97, 0, 250, null, null, null, null, null, null, null);
};

...
//  ********** Library C:\Users\Rob\Natzke Ribbons\01_Particle\01_Spawn_Particle\ParticleEmitter01 **************
// ********** Code for ParticleEmitter01 **************
function ParticleEmitter01() {

}
ParticleEmitter01.prototype.run = function() {
  var $this = this; // closure support
  this.mouseX = (0);
  this.mouseY = (0);
  ...
  canvas.set$width(html_get$$window().get$innerWidth());
  canvas.set$height(html_get$$window().get$innerHeight());
  this.container.get$nodes().add(canvas);
...
ParticleEmitter01.prototype.onDocumentMouseMove = function(event) {
  this.mouseX = event.get$pageX();
  this.mouseY = event.get$pageY();
}
ParticleEmitter01.prototype.get$onDocumentMouseMove = function() {
  return this.onDocumentMouseMove.bind(this);
}
ParticleEmitter01.prototype.spawnParticle = function() {
  this.context.set$fillStyle("rgba( 255, 255, 255, 1 )");
  this.context.beginPath();
  this.context.arc(this.mouseX, this.mouseY, (10), (0), (6.283185), false);

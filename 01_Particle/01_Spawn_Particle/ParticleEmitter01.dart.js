...
$$.ParticleEmitter01 = {"":
 ["mouseY", "mouseX", "context", "container"],
 super: "Object",
 spawnParticle$0: function() {
  this.context.set$fillStyle('rgba( 255, 255, 255, 1 )');
  this.context.beginPath$0();
  this.context.arc$6(this.mouseX, this.mouseY, 10, 0, 6.283185307179586, false);
 ...
 run$0: function() {
  ...
  $.add$1(this.container.get$nodes(), canvas);
  this.context = canvas.getContext$1('2d');
  $.add$1($.document().get$on().get$mouseMove(), this.get$onDocumentMouseMove());
  $.window().setInterval$2(new $.ParticleEmitter01_run_f(this), 50);
 }
};
...
$.ParticleEmitter01$ = function() {
  return new $.ParticleEmitter01(null, null, null, null);
};

...
$$.ParticleEmitter06 = {"":
 ["ground", "airFriction", "gravity", "maxParticles", "particleNum", "particles", "mouseY", "mouseX", "context", "canvas", "container"],
 super: "Object",
 moveParticles$0: function() {
 ...
 run$0: function() {
  ...
  $.window().setInterval$2(new $.ParticleEmitter06_run_f(this), 20);
  $.window().setInterval$2(new $.ParticleEmitter06_run_f0(this), 20);
 }
};
...
$.ParticleEmitter06$ = function() {
  return new $.ParticleEmitter06(600, 0.95, 1, 150, null, null, null, null, null, null, null);
};

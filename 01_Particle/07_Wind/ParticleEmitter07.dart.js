...
$$.ParticleEmitter07 = {"":
 ["ground", "airFriction", "wind", "gravity", "maxParticles", "particleNum", "particles", "mouseY", "mouseX", "context", "canvas", "container"],
 super: "Object",
 moveParticles$0: function() {
  this.context.clearRect$4(0, 0, this.canvas.get$width(), this.canvas.get$height());
  for (var t1 = $.iterator(this.particles.getKeys$0()), t2 = this.wind, t3 = this.gravity, t4 = this.airFriction, t5 = this.ground; t1.hasNext$0() === true; ) {
    var t6 = t1.next$0();
    var p = $.index(this.particles, t6);
    p.set$xSpeed($.add(p.get$xSpeed(), t2));
 ...
 run$0: function() {
  ...
  $.window().setInterval$2(new $.ParticleEmitter07_run_f(this), 20);
  $.window().setInterval$2(new $.ParticleEmitter07_run_f0(this), 20);
 }
};
...
$.ParticleEmitter07$ = function() {
  return new $.ParticleEmitter07(600, 0.95, 1, 1, 150, null, null, null, null, null, null, null);
};

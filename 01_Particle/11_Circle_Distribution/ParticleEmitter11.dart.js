...
//  ********** Library C:\Users\Rob\Natzke Ribbons\01_Particle\11_Circle_Distribution\ParticleEmitter11 **************
// ********** Code for ParticleEmitter11 **************
function ParticleEmitter11() {
  this.maxParticles = (250);
  this.gravity = (0);
  this.airFriction = (0.97);
  this.ground = (600);
}
ParticleEmitter11.prototype.run = function() {
  var $this = this; // closure support
  this.wind = (0);
  this.mouseX = (0);
  this.mouseY = (0);
...
ParticleEmitter11.prototype.onDocumentMouseMove = function(event) {
  this.mouseX = event.get$pageX();
  this.mouseY = event.get$pageY();
}
ParticleEmitter11.prototype.get$onDocumentMouseMove = function() {
  return this.onDocumentMouseMove.bind(this);
}
ParticleEmitter11.prototype.spawnParticle = function() {
  this.particleNum++;
  var mag = (10);
...
ParticleEmitter11.prototype.moveParticles = function() {

...
//  ********** Library C:\Users\Rob\Natzke Ribbons\01_Particle\05_Air_Resistance\ParticleEmitter05 **************
// ********** Code for ParticleEmitter05 **************
function ParticleEmitter05() {
  this.gravity = (1);
  this.airFriction = (0.95);
  this.ground = (600);
}
ParticleEmitter05.prototype.run = function() {
  var $this = this; // closure support
  this.mouseX = (0);
  this.mouseY = (0);
  this.particleNum = (0);
...
ParticleEmitter05.prototype.onDocumentMouseMove = function(event) {
  this.mouseX = event.get$pageX();
  this.mouseY = event.get$pageY();
}
ParticleEmitter05.prototype.get$onDocumentMouseMove = function() {
  return this.onDocumentMouseMove.bind(this);
}
ParticleEmitter05.prototype.spawnParticle = function() {
  this.particleNum++;
  this.particles.$setindex(("p " + this.particleNum), new Particle(this.mouseX, this.mouseY, Math.random() * (4) - (2), Math.random() * (4) - (2)));
}
ParticleEmitter05.prototype.moveParticles = function() {

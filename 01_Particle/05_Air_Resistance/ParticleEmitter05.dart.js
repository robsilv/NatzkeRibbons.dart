...
$$.ParticleEmitter05 = {"":
 ["ground", "airFriction", "gravity", "particleNum", "particles", "mouseY", "mouseX", "context", "canvas", "container"],
 super: "Object",
 moveParticles$0: function() {
 ...
 run$0: function() {
  ...
  $.window().setInterval$2(new $.ParticleEmitter05_run_f(this), 20);
  $.window().setInterval$2(new $.ParticleEmitter05_run_f0(this), 20);
 }
};
...
$.ParticleEmitter05$ = function() {
  return new $.ParticleEmitter05(600, 0.95, 1, null, null, null, null, null, null, null);
};

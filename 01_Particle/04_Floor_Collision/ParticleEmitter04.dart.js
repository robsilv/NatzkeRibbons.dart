...
$$.ParticleEmitter04 = {"":
 ["ground", "gravity", "particleNum", "particles", "mouseY", "mouseX", "context", "canvas", "container"],
 super: "Object",
 moveParticles$0: function() {
  this.context.clearRect$4(0, 0, this.canvas.get$width(), this.canvas.get$height());
  for (var t1 = $.iterator(this.particles.getKeys$0()), t2 = this.gravity, t3 = this.ground; t1.hasNext$0() === true; ) {
    var t4 = t1.next$0();
    var p = $.index(this.particles, t4);
 ...
 run$0: function() {
  ...
  $.window().setInterval$2(new $.ParticleEmitter04_run_f(this), 20);
  $.window().setInterval$2(new $.ParticleEmitter04_run_f0(this), 20);
 }
};
...
$.ParticleEmitter04$ = function() {
  return new $.ParticleEmitter04(600, 1, null, null, null, null, null, null, null);
};

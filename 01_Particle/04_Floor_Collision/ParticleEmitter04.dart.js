...
//  ********** Library C:\Users\Rob\Natzke Ribbons\01_Particle\04_Floor_Collision\ParticleEmitter04 **************
// ********** Code for ParticleEmitter04 **************
function ParticleEmitter04() {
  this.gravity = (1);
  this.ground = (600);
}
ParticleEmitter04.prototype.run = function() {
  var $this = this; // closure support
  this.mouseX = (0);
  this.mouseY = (0);
  this.particleNum = (0);
...
ParticleEmitter04.prototype.onDocumentMouseMove = function(event) {
  this.mouseX = event.get$pageX();
  this.mouseY = event.get$pageY();
}
ParticleEmitter04.prototype.get$onDocumentMouseMove = function() {
  return this.onDocumentMouseMove.bind(this);
}
ParticleEmitter04.prototype.spawnParticle = function() {
  this.particleNum++;
  this.particles.$setindex(("p " + this.particleNum), new Particle(this.mouseX, this.mouseY, Math.random() * (4) - (2), Math.random() * (4) - (2)));
}
ParticleEmitter04.prototype.moveParticles = function() {

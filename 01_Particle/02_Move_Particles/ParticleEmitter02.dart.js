...
$$.ParticleEmitter02 = {"":
 ["particleNum", "particles", "mouseY", "mouseX", "context", "canvas", "container"],
 super: "Object",
 moveParticles$0: function() {
  this.context.clearRect$4(0, 0, this.canvas.get$width(), this.canvas.get$height());
  for (var t1 = $.iterator(this.particles.getKeys$0()); t1.hasNext$0() === true; ) {
    var t2 = t1.next$0();
    var p = $.index(this.particles, t2);
    t2 = $.index(p, 'xSpeed');
    $.indexSet(p, 'x', $.add($.index(p, 'x'), t2));
    var t3 = $.index(p, 'ySpeed');
    $.indexSet(p, 'y', $.add($.index(p, 'y'), t3));
    this.context.set$fillStyle('rgba( 255, 255, 255, 1 )');
    this.context.beginPath$0();
    this.context.arc$6($.index(p, 'x'), $.index(p, 'y'), 10, 0, 6.283185307179586, false);
    this.context.closePath$0();
    this.context.fill$0();
    this.context.set$fillStyle('rgba( 50, 50, 50, 1 )');
    this.context.beginPath$0();
    this.context.arc$6($.index(p, 'x'), $.index(p, 'y'), 8, 0, 6.283185307179586, false);
    this.context.closePath$0();
    this.context.fill$0();
  }
 },
 spawnParticle$0: function() {
  ...
  $.indexSet(this.particles, 'p ' + $.S(this.particleNum), $.makeLiteralMap(['x', this.mouseX, 'y', this.mouseY, 'xSpeed', $.sub($.mul($.Math_random(), 4), 2), 'ySpeed', $.sub($.mul($.Math_random(), 4), 2)]));
 },
 ...
 run$0: function() {
  ...
  $.window().setInterval$2(new $.ParticleEmitter02_run_f(this), 30);
  $.window().setInterval$2(new $.ParticleEmitter02_run_f0(this), 10);
 }
};
...
$.ParticleEmitter02$ = function() {
  return new $.ParticleEmitter02(null, null, null, null, null, null, null);
};

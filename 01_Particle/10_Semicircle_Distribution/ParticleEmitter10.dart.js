...
$$.ParticleEmitter10 = {"":
 ...
 spawnParticle$0: function() {
  ...
  var dir = $.mul($.Math_random(), 3.141592653589793);
  $.indexSet(this.particles, 'p ' + $.S(this.particleNum), $.Particle$(this.mouseX, this.mouseY, $.mul($.Math_cos(dir), 10), $.mul($.Math_sin(dir), 10)));
 ...
 run$0: function() {
  ...
  $.window().setInterval$2(new $.ParticleEmitter10_run_f(this), 20);
  $.window().setInterval$2(new $.ParticleEmitter10_run_f0(this), 20);
 }
};
...
$.ParticleEmitter10$ = function() {
  return new $.ParticleEmitter10(null, 600, 0.97, 0, 250, null, null, null, null, null, null, null);
};

...
//  ********** Library C:\Users\Rob\Natzke Ribbons\01_Particle\10_Semicircle_Distribution\ParticleEmitter10 **************
// ********** Code for ParticleEmitter10 **************
function ParticleEmitter10() {
  this.maxParticles = (250);
  this.gravity = (0);
  this.airFriction = (0.97);
  this.ground = (600);
}
ParticleEmitter10.prototype.run = function() {
  var $this = this; // closure support
  this.wind = (0);
  this.mouseX = (0);
  this.mouseY = (0);
...
ParticleEmitter10.prototype.onDocumentMouseMove = function(event) {
  this.mouseX = event.get$pageX();
  this.mouseY = event.get$pageY();
}
ParticleEmitter10.prototype.get$onDocumentMouseMove = function() {
  return this.onDocumentMouseMove.bind(this);
}
ParticleEmitter10.prototype.spawnParticle = function() {
  this.particleNum++;
  var mag = (10);
  var dir = Math.random() * (3.141593);
...
ParticleEmitter10.prototype.moveParticles = function() {

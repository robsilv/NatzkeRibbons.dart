...
$$.ParticleEmitter03 = {"":
 ["gravity", "particleNum", "particles", "mouseY", "mouseX", "context", "canvas", "container"],
 super: "Object",
 moveParticles$0: function() {
  this.context.clearRect$4(0, 0, this.canvas.get$width(), this.canvas.get$height());
  for (var t1 = $.iterator(this.particles.getKeys$0()), t2 = this.gravity; t1.hasNext$0() === true; ) {
    var t3 = t1.next$0();
    var p = $.index(this.particles, t3);
 ...
 run$0: function() {
  ...
  $.window().setInterval$2(new $.ParticleEmitter03_run_f(this), 20);
  $.window().setInterval$2(new $.ParticleEmitter03_run_f0(this), 20);
 }
};
...
$.ParticleEmitter03$ = function() {
  return new $.ParticleEmitter03(1, null, null, null, null, null, null, null);
};

...
//  ********** Library C:\Users\Rob\Natzke Ribbons\01_Particle\03_Gravity\ParticleEmitter03 **************
// ********** Code for ParticleEmitter03 **************
function ParticleEmitter03() {
  this.gravity = (1);
}
ParticleEmitter03.prototype.run = function() {
  var $this = this; // closure support
  this.mouseX = (0);
  this.mouseY = (0);
  this.particleNum = (0);
...
ParticleEmitter03.prototype.onDocumentMouseMove = function(event) {
  this.mouseX = event.get$pageX();
  this.mouseY = event.get$pageY();
}
ParticleEmitter03.prototype.get$onDocumentMouseMove = function() {
  return this.onDocumentMouseMove.bind(this);
}
ParticleEmitter03.prototype.spawnParticle = function() {
  this.particleNum++;
  this.particles.$setindex(("p " + this.particleNum), new Particle(this.mouseX, this.mouseY, Math.random() * (4) - (2), Math.random() * (4) - (2)));
}
ParticleEmitter03.prototype.moveParticles = function() {

...
//  ********** Library C:\Users\Rob\Natzke Ribbons\01_Particle\12_Random_Magnitude\ParticleEmitter12 **************
// ********** Code for ParticleEmitter12 **************
function ParticleEmitter12() {
  this.maxParticles = (250);
  this.gravity = (0);
  this.airFriction = (0.97);
  this.ground = (600);
}
ParticleEmitter12.prototype.run = function() {
  var $this = this; // closure support
  this.wind = (0);
  this.mouseX = (0);
  this.mouseY = (0);
...
ParticleEmitter12.prototype.onDocumentMouseMove = function(event) {
  this.mouseX = event.get$pageX();
  this.mouseY = event.get$pageY();
}
ParticleEmitter12.prototype.get$onDocumentMouseMove = function() {
  return this.onDocumentMouseMove.bind(this);
}
ParticleEmitter12.prototype.spawnParticle = function() {
  this.particleNum++;
...
ParticleEmitter12.prototype.moveParticles = function() {

...
Ribbon12.prototype.run = function() {
  var $this = this; // closure support
  this.wind = (0);
  this.mouseX = (0);
  this.mouseY = (0);
...
Ribbon12.prototype.onDocumentMouseMove = function(event) {
  this.mouseX = event.get$pageX();
  this.mouseY = event.get$pageY();
}
Ribbon12.prototype.get$onDocumentMouseMove = function() {
  return this.onDocumentMouseMove.bind(this);
}
Ribbon12.prototype.spawnParticle = function() {
  var mag = Math.random() * (2);
  var dir = Math.random() * (3.141593) * (2);
  this.particles.$setindex(("p " + this.particleNum), new Particle(this.mouseX, this.mouseY, Math.cos(dir) * mag, Math.sin(dir) * mag, (0), Math.random() * (16777215)));
...
Ribbon12.prototype.moveParticles = function() {
  ...
  for (var c = this.particleNum - (1);
   c > min; c--) {
    ...
    if (c == this.particleNum - (1)) {
      ...
      this.context.moveTo(nb.midPointX, nb.midPointY);
      this.context.quadraticCurveTo(nb.x, nb.y, p.midPointX, p.midPointY);
    }
  ...
  for (var c = this.particleNum - (1);
   c > min; c--) {
    ...
    this.context.beginPath();
    this.context.arc(p.x, p.y, (6), (0), (6.283185), false);
    this.context.closePath();
    this.context.fill();
    this.context.set$fillStyle("rgba( 50, 50, 50, 1 )");
    this.context.beginPath();
    this.context.arc(p.x, p.y, (5), (0), (6.283185), false);
    this.context.closePath();
    this.context.fill();
  }
}

...
$$.Ribbon04 = {"":
 ...
 moveParticles$0: function() {
  ...
  for (; c > min; --c) {
    ...
    if (c === $.sub(this.particleNum, 1)) this.context.moveTo$2(p.get$x(), p.get$y());
      ...
      t2 = $.sub(t2, 20 * t9);
      var t10 = nb.get$y();
      var t11 = $.Math_sin(myAngle);
      if (typeof t11 !== 'number') throw $.iae(t11);
      t1.moveTo$2(t2, $.sub(t10, 20 * t11));
    }
  }
  this.context.set$lineJoin('round');
  this.context.set$lineCap('round');
 ...
 run$0: function() {
  ...
  $.window().setInterval$2(new $.Ribbon04_run_f(this), $.toInt(100.0));
  $.window().setInterval$2(new $.Ribbon04_run_f0(this), $.toInt(33.333333333333336));
 }
};
...
$.Ribbon04$ = function() {
  return new $.Ribbon04(null, 600, 0.97, 0.5, 100, 25, null, null, null, null, null, null, null);
};

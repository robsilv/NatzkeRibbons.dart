...
Ribbon15.prototype.run = function() {
  var $this = this; // closure support
  this.wind = (0);
  this.mouseX = (0);
  this.mouseY = (0);
...
Ribbon15.prototype.onDocumentMouseMove = function(event) {
  this.mouseX = event.get$pageX();
  this.mouseY = event.get$pageY();
}
Ribbon15.prototype.get$onDocumentMouseMove = function() {
  return this.onDocumentMouseMove.bind(this);
}
Ribbon15.prototype.spawnParticle = function() {
...
Ribbon15.prototype.moveParticles = function() {
...
Ribbon15.prototype.hexToRGB = function(hex) {
  hex = hex.floor();
  var r = (hex >> (16) & (255));
  var g = (hex >> (8) & (255));
  var b = (hex & (255));

...
$$.Ribbon15 = {"":
 ...
 moveParticles$0: function() {
  ...
  if (typeof c !== 'number') return this.moveParticles$0$bailout(3, min, c, 0);
  t2 = min + 1;
  for (; c > min; --c) {
    ...
    if (c === $.sub(this.particleNum, 1)) this.context.moveTo$2(p.get$x(), p.get$y());
      ...
      if (c > t2) {
        ...
        t1 = $.toRadixString($.toInt(p.get$color()), 16);
 ...
 run$0: function() {
  ...
  $.window().setInterval$2(new $.Ribbon15_run_f(this), $.toInt(100.0));
  $.window().setInterval$2(new $.Ribbon15_run_f0(this), $.toInt(33.333333333333336));
 }
};
...
$.Ribbon15$ = function() {
  return new $.Ribbon15(null, 600, 0.97, 0.5, 100, 200, null, null, null, null, null, null, null);
};

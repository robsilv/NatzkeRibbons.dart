...
$$.Ribbon06 = {"":
 ...
 moveParticles$0: function() {
  ...
  for (; c > min; --c) {
    ...
    if (c === $.sub(this.particleNum, 1)) this.context.moveTo$2(p.get$x(), p.get$y());
      ...
      t5 = $.Math_sin(myAngle);
      if (typeof t5 !== 'number') throw $.iae(t5);
      t1.quadraticCurveTo$4(t2, $.sub(t4, 20 * t5), nbB.get$midPointX(), nbB.get$midPointY());
    }
  }
  this.context.set$lineJoin('round');
  this.context.set$lineCap('round');
 ...
 run$0: function() {
  ...
  $.window().setInterval$2(new $.Ribbon06_run_f(this), $.toInt(100.0));
  $.window().setInterval$2(new $.Ribbon06_run_f0(this), $.toInt(33.333333333333336));
 }
};
...
$.Particle$ = function(x, y, xSpeed, ySpeed, radius) {
  return new $.Particle(null, null, null, null, null, null, radius, ySpeed, xSpeed, y, x);
};
...
$.Ribbon06$ = function() {
  return new $.Ribbon06(null, 600, 0.97, 0.5, 100, 25, null, null, null, null, null, null, null);
};

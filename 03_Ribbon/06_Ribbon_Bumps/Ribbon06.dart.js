...
Ribbon06.prototype.run = function() {
  var $this = this; // closure support
  this.wind = (0);
  this.mouseX = (0);
  this.mouseY = (0);
...
Ribbon06.prototype.onDocumentMouseMove = function(event) {
  this.mouseX = event.get$pageX();
  this.mouseY = event.get$pageY();
}
Ribbon06.prototype.get$onDocumentMouseMove = function() {
  return this.onDocumentMouseMove.bind(this);
}
Ribbon06.prototype.spawnParticle = function() {
...
Ribbon06.prototype.moveParticles = function() {
  ...
  for (var c = this.particleNum - (1);
   c > min; c--) {
    ...
    if (c == this.particleNum - (1)) {
      ...
      var myAngle = p.angle + (1.570796);
      this.context.quadraticCurveTo(p.x - (20) * Math.cos(myAngle), p.y - (20) * Math.sin(myAngle), nbB.midPointX, nbB.midPointY);
    }
  }
  this.context.set$lineJoin("round");
  this.context.set$lineCap("round");

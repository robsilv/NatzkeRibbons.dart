...
$$.Ribbon02 = {"":
 ...
 run$0: function() {
  ...
  $.window().setInterval$2(new $.Ribbon02_run_f(this), $.toInt(100.0));
  $.window().setInterval$2(new $.Ribbon02_run_f0(this), $.toInt(33.333333333333336));
 }
};
...
$.Ribbon02$ = function() {
  return new $.Ribbon02(null, 600, 0.97, 0.5, 100, 25, null, null, null, null, null, null, null);
};

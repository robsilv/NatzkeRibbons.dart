  ...
  void moveParticles()
  {
    ...
    {  
      ...
      if ( c == particleNum-1 ) {
        ...
        context.moveTo(p.x+20*Math.cos(p.angle), p.y+20*Math.sin(p.angle));
        context.lineTo(p.x-20*Math.cos(p.angle), p.y-20*Math.sin(p.angle));
      }
...
class Particle 
{  
  num x, y, xSpeed, ySpeed, radius, midPointX, midPointY, distance, angle;

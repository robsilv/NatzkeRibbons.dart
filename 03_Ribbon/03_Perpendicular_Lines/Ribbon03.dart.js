...
$$.Ribbon03 = {"":
 ...
 moveParticles$0: function() {
  ...
  for (; c > min; --c) {
    ...
    p.set$angle($.add(p.get$angle(), 1.5707963267948966));
  }
  ...
  for (; c > min; --c) {
    ...
    if (t1) t2.moveTo$2(p.get$x(), p.get$y());
      ...
      t1 = p.get$x();
      t3 = $.Math_cos(p.get$angle());
      if (typeof t3 !== 'number') throw $.iae(t3);
      t1 = $.add(t1, 20 * t3);
      t4 = p.get$y();
      t5 = $.Math_sin(p.get$angle());
      if (typeof t5 !== 'number') throw $.iae(t5);
      t2.moveTo$2(t1, $.add(t4, 20 * t5));
      t1 = this.context;
      t2 = p.get$x();
      t6 = $.Math_cos(p.get$angle());
      if (typeof t6 !== 'number') throw $.iae(t6);
      t2 = $.sub(t2, 20 * t6);
      t7 = p.get$y();
      t8 = $.Math_sin(p.get$angle());
      if (typeof t8 !== 'number') throw $.iae(t8);
      t1.lineTo$2(t2, $.sub(t7, 20 * t8));
    }
    this.context.set$lineJoin('round');
    this.context.set$lineCap('round');
 ...
 run$0: function() {
  ...
  $.window().setInterval$2(new $.Ribbon03_run_f(this), $.toInt(100.0));
  $.window().setInterval$2(new $.Ribbon03_run_f0(this), $.toInt(33.333333333333336));
 }
};

$$.Particle = {"":
 ["angle=", "distance=", "midPointY=", "midPointX=", "radius=", "ySpeed=", "xSpeed=", "y=", "x="],
 super: "Object"
};
...
$.Ribbon03$ = function() {
  return new $.Ribbon03(null, 600, 0.97, 0.5, 100, 25, null, null, null, null, null, null, null);
};
...
$.Particle$ = function(x, y, xSpeed, ySpeed, radius) {
  return new $.Particle(null, null, null, null, radius, ySpeed, xSpeed, y, x);
};

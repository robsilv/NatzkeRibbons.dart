...
Ribbon07.prototype.run = function() {
  var $this = this; // closure support
  this.wind = (0);
  this.mouseX = (0);
  this.mouseY = (0);
...
Ribbon07.prototype.onDocumentMouseMove = function(event) {
  this.mouseX = event.get$pageX();
  this.mouseY = event.get$pageY();
}
Ribbon07.prototype.get$onDocumentMouseMove = function() {
  return this.onDocumentMouseMove.bind(this);
}
Ribbon07.prototype.spawnParticle = function() {
...
Ribbon07.prototype.moveParticles = function() {
  ...
  for (var c = this.particleNum - (1);
   c > min; c--) {
    ...
    if (c == this.particleNum - (1)) {
      ...
      var myAngle = nb.angle + (1.570796);
      this.context.quadraticCurveTo(p.x - (20) * Math.cos(myAngle), p.y - (20) * Math.sin(myAngle), nbB.midPointX - (20) * Math.cos(myAngle), nbB.midPointY - (20) * Math.sin(myAngle));
    }
  }
  this.context.set$lineJoin("round");
  this.context.set$lineCap("round");

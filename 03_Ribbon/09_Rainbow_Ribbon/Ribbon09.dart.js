...
$$.Ribbon09 = {"":
 ...
 moveParticles$0: function() {
  ...
  for (; c > min; --c) {
    ...
    if (c === $.sub(this.particleNum, 1)) this.context.moveTo$2(p.get$x(), p.get$y());
      ...
      t1 = nbB.get$x();
      t2 = $.Math_cos($.add(nbB.get$angle(), 1.5707963267948966));
      if (typeof t2 !== 'number') throw $.iae(t2);
      t1 = $.add(t1, 20 * t2);
      t3 = nbB.get$y();
      t4 = $.Math_sin($.add(nbB.get$angle(), 1.5707963267948966));
      if (typeof t4 !== 'number') throw $.iae(t4);
      var point_a = $.Point2D$(t1, $.add(t3, 20 * t4));
      t1 = nbB.get$x();
      t5 = $.Math_cos($.add(nbB.get$angle(), 1.5707963267948966));
      if (typeof t5 !== 'number') throw $.iae(t5);
      t1 = $.sub(t1, 20 * t5);
      t6 = nbB.get$y();
      t7 = $.Math_sin($.add(nbB.get$angle(), 1.5707963267948966));
      if (typeof t7 !== 'number') throw $.iae(t7);
      var point_b = $.Point2D$(t1, $.sub(t6, 20 * t7));
      t1 = p.get$x();
      t8 = $.Math_cos($.add(p.get$angle(), 1.5707963267948966));
      if (typeof t8 !== 'number') throw $.iae(t8);
      t1 = $.add(t1, 20 * t8);
      t9 = p.get$y();
      var t10 = $.Math_sin($.add(p.get$angle(), 1.5707963267948966));
      if (typeof t10 !== 'number') throw $.iae(t10);
      var point_c = $.Point2D$(t1, $.add(t9, 20 * t10));
      t1 = p.get$x();
      var t11 = $.Math_cos($.add(p.get$angle(), 1.5707963267948966));
      if (typeof t11 !== 'number') throw $.iae(t11);
      t1 = $.sub(t1, 20 * t11);
      var t12 = p.get$y();
      var t13 = $.Math_sin($.add(p.get$angle(), 1.5707963267948966));
      if (typeof t13 !== 'number') throw $.iae(t13);
      var point_d = $.Point2D$(t1, $.sub(t12, 20 * t13));
      t1 = nb.get$x();
      var t14 = $.Math_cos($.add(nb.get$angle(), 1.5707963267948966));
      if (typeof t14 !== 'number') throw $.iae(t14);
      t1 = $.add(t1, 20 * t14);
      var t15 = nb.get$y();
      var t16 = $.Math_sin($.add(nb.get$angle(), 1.5707963267948966));
      if (typeof t16 !== 'number') throw $.iae(t16);
      var point_e = $.Point2D$(t1, $.add(t15, 20 * t16));
      t1 = nb.get$x();
      var t17 = $.Math_cos($.add(nb.get$angle(), 1.5707963267948966));
      if (typeof t17 !== 'number') throw $.iae(t17);
      t1 = $.sub(t1, 20 * t17);
      var t18 = nb.get$y();
      var t19 = $.Math_sin($.add(nb.get$angle(), 1.5707963267948966));
      if (typeof t19 !== 'number') throw $.iae(t19);
      var point_f = $.Point2D$(t1, $.sub(t18, 20 * t19));
      t1 = point_a.x;
      t1 = $.add(t1, $.mul($.sub(point_c.x, t1), 0.5));
      var t20 = point_a.y;
      var point_ac = $.Point2D$(t1, $.add(t20, $.mul($.sub(point_c.y, t20), 0.5)));
      t1 = point_c.x;
      t1 = $.add(t1, $.mul($.sub(point_e.x, t1), 0.5));
      var t21 = point_c.y;
      var point_ce = $.Point2D$(t1, $.add(t21, $.mul($.sub(point_e.y, t21), 0.5)));
      t1 = point_b.x;
      t1 = $.add(t1, $.mul($.sub(point_d.x, t1), 0.5));
      var t22 = point_b.y;
      var point_bd = $.Point2D$(t1, $.add(t22, $.mul($.sub(point_d.y, t22), 0.5)));
      t1 = point_d.x;
      t1 = $.add(t1, $.mul($.sub(point_f.x, t1), 0.5));
      var t23 = point_d.y;
      var point_df = $.Point2D$(t1, $.add(t23, $.mul($.sub(point_f.y, t23), 0.5)));
      this.context.beginPath$0();
      this.context.set$lineWidth(1);
      this.context.moveTo$2(point_a.x, point_a.y);
      this.context.lineTo$2(point_b.x, point_b.y);
      this.context.lineTo$2(point_bd.x, point_bd.y);
      this.context.lineTo$2(point_d.x, point_d.y);
      this.context.lineTo$2(point_df.x, point_df.y);
      this.context.lineTo$2(point_f.x, point_f.y);
      this.context.lineTo$2(point_e.x, point_e.y);
      this.context.lineTo$2(point_ce.x, point_ce.y);
      this.context.lineTo$2(point_c.x, point_c.y);
      this.context.lineTo$2(point_ac.x, point_ac.y);
      this.context.lineTo$2(point_a.x, point_a.y);
      this.context.set$lineJoin('round');
      this.context.set$lineCap('round');
 ...
 spawnParticle$0: function() {
  ...
  $.indexSet(this.particles, 'p ' + $.S(this.particleNum), $.Particle$(this.mouseX, this.mouseY, $.mul($.Math_cos(dir), mag), $.mul($.Math_sin(dir), mag), $.mul($.Math_random(), 20), $.mul($.Math_random(), 16777215)));
  var t1 = this.particleNum;
  var t2 = this.maxParticles;
  if ($.gtB(t1, t2)) {
 ...
 run$0: function() {
  ...
  $.window().setInterval$2(new $.Ribbon09_run_f(this), $.toInt(100.0));
  $.window().setInterval$2(new $.Ribbon09_run_f0(this), $.toInt(33.333333333333336));
 }
};
...
$.Ribbon09$ = function() {
  return new $.Ribbon09(null, 600, 0.97, 0.5, 100, 25, null, null, null, null, null, null, null);
};

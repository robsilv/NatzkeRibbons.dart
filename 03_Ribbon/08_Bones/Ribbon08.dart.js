...
$$.Ribbon08 = {"":
 ...
 moveParticles$0: function() {
  ...
  for (; c > min; --c) {
    ...
    if (c === $.sub(this.particleNum, 1)) this.context.moveTo$2(p.get$x(), p.get$y());
      ...
      this.context.beginPath$0();
      this.context.set$lineWidth(1);
      this.context.moveTo$2(point_ac.x, point_ac.y);
      ...
      this.context.beginPath$0();
      this.context.set$lineWidth(4);
      this.context.moveTo$2(point_c.x, point_c.y);
      ...
      this.context.beginPath$0();
      this.context.set$lineWidth(1);
      this.context.moveTo$2(point_e.x, point_e.y);
  ...
  c = $.sub(this.particleNum, 1);
  if (typeof c !== 'number') return this.moveParticles$0$bailout(6, min, c, 0);
  for (; c > min; --c) {
    p = $.index(this.particles, 'p ' + $.S(c));
 ...
 run$0: function() {
  ...
  $.window().setInterval$2(new $.Ribbon08_run_f(this), $.toInt(100.0));
  $.window().setInterval$2(new $.Ribbon08_run_f0(this), $.toInt(33.333333333333336));
 }
};
...
$.Ribbon08$ = function() {
  return new $.Ribbon08(null, 600, 0.97, 0.5, 100, 25, null, null, null, null, null, null, null);
};

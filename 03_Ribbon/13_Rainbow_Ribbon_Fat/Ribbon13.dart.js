...
$$.Ribbon13 = {"":
 ...
 moveParticles$0: function() {
  ...
  c = $.sub(this.particleNum, 1);
  if (typeof c !== 'number') return this.moveParticles$0$bailout(4, min, c, 0);
  t2 = min + 1;
  for (; c > min; --c) {
    p = $.index(this.particles, 'p ' + $.S(c));
    nb = $.index(this.particles, 'p ' + $.S(c + 1));
    ...
    if (c === $.sub(this.particleNum, 1)) this.context.moveTo$2(p.get$x(), p.get$y());
      ...
      if (c > t2) {
        ...
        this.context.moveTo$2(p.get$midPointX(), p.get$midPointY());
        this.context.set$lineJoin('round');
        this.context.set$lineCap('round');
 ...
 spawnParticle$0: function() {
  ...
  $.indexSet(this.particles, 'p ' + $.S(this.particleNum), $.Particle$(this.mouseX, this.mouseY, $.mul($.Math_cos(dir), mag), $.mul($.Math_sin(dir), mag), 0, $.mul($.Math_random(), 16777215)));
  var t1 = this.particleNum;
  var t2 = this.maxParticles;
  if ($.gtB(t1, t2)) {
 ...
 run$0: function() {
  ...
  $.window().setInterval$2(new $.Ribbon13_run_f(this), $.toInt(100.0));
  $.window().setInterval$2(new $.Ribbon13_run_f0(this), $.toInt(33.333333333333336));
 }
};
...
$.Ribbon13$ = function() {
  return new $.Ribbon13(null, 600, 0.97, 0.5, 100, 25, null, null, null, null, null, null, null);
};
...
$.$defineNativeClass('CanvasRenderingContext2D', ["strokeStyle!", "lineWidth!", "lineJoin!", "lineCap!"], {
 stroke$0: function() {
  return this.stroke();
 },

...
$$.Ribbon05 = {"":
 ...
 moveParticles$0: function() {
  ...
  for (; c > min; --c) {
    ...
    if (c === $.sub(this.particleNum, 1)) this.context.moveTo$2(p.get$x(), p.get$y());
      ...
      myAngle = $.add(p.get$angle(), 1.5707963267948966);
      t1 = this.context;
      t2 = p.get$x();
      t3 = $.Math_cos(myAngle);
      if (typeof t3 !== 'number') throw $.iae(t3);
  ...
  this.context.stroke$0();
  c = $.sub(this.particleNum, 1);
  if (typeof c !== 'number') return this.moveParticles$0$bailout(7, c, min, 0);
  for (; c > min; --c) {
    p = $.index(this.particles, 'p ' + $.S(c));
 ...
 run$0: function() {
  ...
  $.window().setInterval$2(new $.Ribbon05_run_f(this), $.toInt(100.0));
  $.window().setInterval$2(new $.Ribbon05_run_f0(this), $.toInt(33.333333333333336));
 }
};
...
$.Ribbon05$ = function() {
  return new $.Ribbon05(null, 600, 0.97, 0.5, 100, 25, null, null, null, null, null, null, null);
};

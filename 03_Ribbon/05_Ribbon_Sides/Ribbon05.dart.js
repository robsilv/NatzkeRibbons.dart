...
Ribbon05.prototype.run = function() {
  var $this = this; // closure support
  this.wind = (0);
  this.mouseX = (0);
  this.mouseY = (0);
...
Ribbon05.prototype.onDocumentMouseMove = function(event) {
  this.mouseX = event.get$pageX();
  this.mouseY = event.get$pageY();
}
Ribbon05.prototype.get$onDocumentMouseMove = function() {
  return this.onDocumentMouseMove.bind(this);
}
Ribbon05.prototype.spawnParticle = function() {
...
Ribbon05.prototype.moveParticles = function() {
  ...
  for (var c = this.particleNum - (1);
   c > min; c--) {
    ...
    if (c == this.particleNum - (1)) {
      ...
      this.context.lineTo(nb.x - (20) * Math.cos(myAngle), nb.y - (20) * Math.sin(myAngle));
      this.context.moveTo(nb.x - (20) * Math.cos(myAngle), nb.y - (20) * Math.sin(myAngle));
    }
  }
  this.context.set$lineJoin("round");
  this.context.set$lineCap("round");
  ...
  this.context.set$lineJoin("round");
  this.context.set$lineCap("round");
  this.context.set$strokeStyle("#88FF44");
  this.context.stroke();
  for (var c = this.particleNum - (1);
   c > min; c--) {
    var p = this.particles.$index(("p " + c));

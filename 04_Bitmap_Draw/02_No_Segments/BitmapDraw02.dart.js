...
// ********** Code for BitmapDraw02 **************
function BitmapDraw02() {
...
BitmapDraw02.prototype.run = function() {
  var $this = this; // closure support
  this.wind = (0);
  this.mouseX = (0);
  this.mouseY = (0);
...
BitmapDraw02.prototype.onDocumentMouseMove = function(event) {
  this.mouseX = event.get$pageX();
  this.mouseY = event.get$pageY();
}
BitmapDraw02.prototype.get$onDocumentMouseMove = function() {
  return this.onDocumentMouseMove.bind(this);
}
BitmapDraw02.prototype.spawnParticle = function() {
...
BitmapDraw02.prototype.moveParticles = function() {
...
BitmapDraw02.prototype.hexToRGB = function(hex) {
  hex = hex.floor();
  var r = (hex >> (16) & (255));
  var g = (hex >> (8) & (255));
  var b = (hex & (255));

...
$$.BitmapDraw02 = {"":
 ...
 moveParticles$0: function() {
  ...
  if (typeof c !== 'number') return this.moveParticles$0$bailout(2, t2, c, min);
  var t3 = this.gravity;
 ...
 run$0: function() {
  ...
  $.window().setInterval$2(new $.BitmapDraw02_run_f(this), $.toInt(100.0));
  $.window().setInterval$2(new $.BitmapDraw02_run_f0(this), $.toInt(50.0));
 }
};
...
$.BitmapDraw02$ = function() {
  return new $.BitmapDraw02(null, 600, 0.97, 0.5, 100, 25, null, null, null, null, null, null, null);
};

...
// ********** Code for BitmapDraw03 **************
function BitmapDraw03() {
...
BitmapDraw03.prototype.run = function() {
  var $this = this; // closure support
  this.wind = (0);
  this.mouseX = (0);
  this.mouseY = (0);
...
BitmapDraw03.prototype.onDocumentMouseMove = function(event) {
  this.mouseX = event.get$pageX();
  this.mouseY = event.get$pageY();
}
BitmapDraw03.prototype.get$onDocumentMouseMove = function() {
  return this.onDocumentMouseMove.bind(this);
}
BitmapDraw03.prototype.spawnParticle = function() {
  var mag = Math.random() * (2);
  var dir = Math.random() * (3.141593) * (2);
  this.particles.$setindex(("p " + this.particleNum), new Particle(this.mouseX, this.mouseY, Math.cos(dir) * mag, Math.sin(dir) * mag, (0), (16777215)));
...
BitmapDraw03.prototype.step = function() {
...
BitmapDraw03.prototype.render = function() {
  var min = this.particleNum - this.maxParticles;
  if (min < (0)) min = (0);
  for (var c = this.particleNum - (1);
   c > min; c--) {
...
BitmapDraw03.prototype.hexToRGB = function(hex) {
  hex = hex.floor();
  var r = (hex >> (16) & (255));
  var g = (hex >> (8) & (255));
  var b = (hex & (255));
...
(function(){
  ...
  var v7/*Entry*/ = 'Entry|DirectoryEntry|FileEntry';
  ...
  var v10/*EventTarget*/ = [v2/*AbstractWorker*/,v3/*Node*/,'EventTarget|DOMApplicationCache|DOMWindow|EventSource|MessagePort|Notification|SVGElementInstance|WebSocket|XMLHttpRequest|XMLHttpRequestUpload'].join('|');
  var v11/*HTMLCollection*/ = 'HTMLCollection|HTMLOptionsCollection';
  var v12/*IDBRequest*/ = 'IDBRequest|IDBVersionChangeRequest';
  var v13/*MediaStream*/ = 'MediaStream|LocalMediaStream';

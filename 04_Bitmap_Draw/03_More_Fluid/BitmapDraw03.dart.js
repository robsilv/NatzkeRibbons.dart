...
$$.BitmapDraw03 = {"":
 ...
 spawnParticle$0: function() {
  ...
  $.indexSet(this.particles, 'p ' + $.S(this.particleNum), $.Particle$(this.mouseX, this.mouseY, $.mul($.Math_cos(dir), mag), $.mul($.Math_sin(dir), mag), 0, 16777215));
  var t1 = this.particleNum;
  var t2 = this.maxParticles;
  if ($.gtB(t1, t2)) {
 ...
 run$0: function() {
  ...
  $.window().setInterval$2(new $.BitmapDraw03_run_f(this), $.toInt(100.0));
  $.window().setInterval$2(new $.BitmapDraw03_run_f0(this), $.toInt(33.333333333333336));
  $.window().setInterval$2(new $.BitmapDraw03_run_f1(this), $.toInt(10.0));
 }
};
...
$.BitmapDraw03$ = function() {
  return new $.BitmapDraw03(null, 600, 0.97, 0.5, 100, 25, null, null, null, null, null, null, null);
};

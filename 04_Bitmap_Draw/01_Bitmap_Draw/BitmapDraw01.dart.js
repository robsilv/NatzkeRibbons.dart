...
$$.BitmapDraw01 = {"":
 ...
 moveParticles$0: function() {
  ...
  var min = $.sub(t1, t2);
  if ($.ltB(min, 0)) min = 0;
  if (typeof min !== 'number') return this.moveParticles$0$bailout(1, min, t2, 0);
  var c = $.sub(this.particleNum, 1);
  if (typeof c !== 'number') return this.moveParticles$0$bailout(2, c, min, t2);
  var t3 = this.gravity;
  ...
  for (; c > min; --c) {
    ...
    if (c === $.sub(this.particleNum, 1)) this.context.moveTo$2(p.get$x(), p.get$y());
      ...
      if (c > t2) {
        ...
        this.context.set$strokeStyle('#222222');
 ...
 run$0: function() {
  ...
  $.window().setInterval$2(new $.BitmapDraw01_run_f(this), $.toInt(100.0));
  $.window().setInterval$2(new $.BitmapDraw01_run_f0(this), $.toInt(50.0));
 }
};
...
$.BitmapDraw01$ = function() {
  return new $.BitmapDraw01(null, 600, 0.97, 0.5, 100, 25, null, null, null, null, null, null, null);
};

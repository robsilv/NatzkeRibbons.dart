...
// ********** Code for BitmapDraw01 **************
function BitmapDraw01() {
...
BitmapDraw01.prototype.run = function() {
  var $this = this; // closure support
  this.wind = (0);
  this.mouseX = (0);
  this.mouseY = (0);
...
BitmapDraw01.prototype.onDocumentMouseMove = function(event) {
  this.mouseX = event.get$pageX();
  this.mouseY = event.get$pageY();
}
BitmapDraw01.prototype.get$onDocumentMouseMove = function() {
  return this.onDocumentMouseMove.bind(this);
}
BitmapDraw01.prototype.spawnParticle = function() {
...
BitmapDraw01.prototype.moveParticles = function() {
...
BitmapDraw01.prototype.hexToRGB = function(hex) {
  hex = hex.floor();
  var r = (hex >> (16) & (255));
  var g = (hex >> (8) & (255));
  var b = (hex & (255));

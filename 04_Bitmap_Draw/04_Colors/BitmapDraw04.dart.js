...
$$.Object = {"":
 ...
 hexToRGB$1: function (arg0) {
  return this.noSuchMethod$2
      ? this.noSuchMethod$2('hexToRGB', [arg0])
      : $.Object.prototype.noSuchMethod$2.call(this, 'hexToRGB', [arg0])
},
 ...
 step$0: function () {
  return this.noSuchMethod$2
      ? this.noSuchMethod$2('step', [])
      : $.Object.prototype.noSuchMethod$2.call(this, 'step', [])
},
 ...
 rgbToHex$3: function (arg0, arg1, arg2) {
  return this.noSuchMethod$2
      ? this.noSuchMethod$2('rgbToHex', [arg0, arg1, arg2])
      : $.Object.prototype.noSuchMethod$2.call(this, 'rgbToHex', [arg0, arg1, arg2])
},
 isEmpty$0: function () {
  return this.noSuchMethod$2
 ...
 get$imageLoaded: function () {
  return this.noSuchMethod$2
      ? this.noSuchMethod$2('get imageLoaded', [])
      : $.Object.prototype.noSuchMethod$2.call(this, 'get imageLoaded', [])
},
...
$$.BitmapDraw04 = {"":
 ["wind", "ground", "airFriction", "gravity", "maxDistance", "maxParticles", "particleNum", "particles", "mouseY", "mouseX", "image", "imgContext", "context", "imgCanvas", "canvas", "container"],
 super: "Object",
 rgbToHex$3: function(r, g, b) {
  return $.xor($.xor($.shl(r, 16), $.shl(g, 8)), b);
 },
 hexToRGB$1: function(hex) {
  hex = $.floor(hex);
  if (hex !== (hex | 0)) return this.hexToRGB$1$bailout(1, hex);
  return [$.shr(hex, 16) & 255, $.shr(hex, 8) & 255, hex & 255];
 },
 hexToRGB$1$bailout: function(state, hex) {
  return [$.and($.shr(hex, 16), 255), $.and($.shr(hex, 8), 255), $.and(hex, 255)];
 },
 render$0: function() {
  var min = $.sub(this.particleNum, this.maxParticles);
  if ($.ltB(min, 0)) min = 0;
  if (typeof min !== 'number') return this.render$0$bailout(1, min, 0);
  var c = $.sub(this.particleNum, 1);
  if (typeof c !== 'number') return this.render$0$bailout(2, c, min);
  var t2 = min + 1;
  for (; c > min; --c) {
    ...
    if (c === $.sub(this.particleNum, 1)) this.context.moveTo$2(p.get$x(), p.get$y());
      ...
      if (c > t2) {
        var point_a = $.Point2D$($.add(nbB.get$x(), $.mul(nbB.get$radius(), $.Math_cos($.add(nbB.get$angle(), 1.5707963267948966)))), $.add(nbB.get$y(), $.mul(nbB.get$radius(), $.Math_sin($.add(nbB.get$angle(), 1.5707963267948966)))));
        var point_b = $.Point2D$($.sub(nbB.get$x(), $.mul(nbB.get$radius(), $.Math_cos($.add(nbB.get$angle(), 1.5707963267948966)))), $.sub(nbB.get$y(), $.mul(nbB.get$radius(), $.Math_sin($.add(nbB.get$angle(), 1.5707963267948966)))));
        var point_c = $.Point2D$($.add(p.get$x(), $.mul(p.get$radius(), $.Math_cos($.add(p.get$angle(), 1.5707963267948966)))), $.add(p.get$y(), $.mul(p.get$radius(), $.Math_sin($.add(p.get$angle(), 1.5707963267948966)))));
        var point_d = $.Point2D$($.sub(p.get$x(), $.mul(p.get$radius(), $.Math_cos($.add(p.get$angle(), 1.5707963267948966)))), $.sub(p.get$y(), $.mul(p.get$radius(), $.Math_sin($.add(p.get$angle(), 1.5707963267948966)))));
        var point_e = $.Point2D$($.add(nb.get$x(), $.mul(nb.get$radius(), $.Math_cos($.add(nb.get$angle(), 1.5707963267948966)))), $.add(nb.get$y(), $.mul(nb.get$radius(), $.Math_sin($.add(nb.get$angle(), 1.5707963267948966)))));
        var point_f = $.Point2D$($.sub(nb.get$x(), $.mul(nb.get$radius(), $.Math_cos($.add(nb.get$angle(), 1.5707963267948966)))), $.sub(nb.get$y(), $.mul(nb.get$radius(), $.Math_sin($.add(nb.get$angle(), 1.5707963267948966)))));
        var t1 = point_a.x;
        t1 = $.add(t1, $.mul($.sub(point_c.x, t1), 0.5));
        var t3 = point_a.y;
        var point_ac = $.Point2D$(t1, $.add(t3, $.mul($.sub(point_c.y, t3), 0.5)));
        t1 = point_c.x;
        t1 = $.add(t1, $.mul($.sub(point_e.x, t1), 0.5));
        var t4 = point_c.y;
        var point_ce = $.Point2D$(t1, $.add(t4, $.mul($.sub(point_e.y, t4), 0.5)));
        t1 = point_b.x;
        t1 = $.add(t1, $.mul($.sub(point_d.x, t1), 0.5));
        var t5 = point_b.y;
        var point_bd = $.Point2D$(t1, $.add(t5, $.mul($.sub(point_d.y, t5), 0.5)));
        t1 = point_d.x;
        t1 = $.add(t1, $.mul($.sub(point_f.x, t1), 0.5));
        var t6 = point_d.y;
        var point_df = $.Point2D$(t1, $.add(t6, $.mul($.sub(point_f.y, t6), 0.5)));
        var rgb = this.hexToRGB$1(p.get$color());
        this.context.beginPath$0();
        t1 = 'rgba( ' + $.S($.index(rgb, 0)) + ', ' + $.S($.index(rgb, 1)) + ', ' + $.S($.index(rgb, 2)) + ', .25 )';
        this.context.set$fillStyle(t1);
        this.context.moveTo$2(point_bd.x, point_bd.y);
        this.context.quadraticCurveTo$4(point_d.x, point_d.y, point_df.x, point_df.y);
        this.context.lineTo$2(point_ce.x, point_ce.y);
        this.context.quadraticCurveTo$4(point_c.x, point_c.y, point_ac.x, point_ac.y);
        this.context.lineTo$2(point_bd.x, point_bd.y);
        this.context.fill$0();
        var rgb0 = this.hexToRGB$1(2236962);
        this.context.set$lineWidth(1);
        this.context.set$lineJoin('round');
        this.context.set$lineCap('round');
        t1 = 'rgba( ' + $.S($.index(rgb0, 0)) + ', ' + $.S($.index(rgb0, 1)) + ', ' + $.S($.index(rgb0, 2)) + ', 0 )';
        this.context.set$strokeStyle(t1);
        this.context.stroke$0();
        this.context.beginPath$0();
        this.context.moveTo$2(point_bd.x, point_bd.y);
        this.context.quadraticCurveTo$4(point_d.x, point_d.y, point_df.x, point_df.y);
        this.context.moveTo$2(point_ce.x, point_ce.y);
        this.context.quadraticCurveTo$4(point_c.x, point_c.y, point_ac.x, point_ac.y);
        var rgb1 = this.hexToRGB$1(2236962);
        this.context.set$lineWidth(1);
        this.context.set$lineJoin('round');
        this.context.set$lineCap('round');
        t1 = 'rgba( ' + $.S($.index(rgb1, 0)) + ', ' + $.S($.index(rgb1, 1)) + ', ' + $.S($.index(rgb1, 2)) + ', 1 )';
        this.context.set$strokeStyle(t1);
        this.context.stroke$0();
      }
    }
 ...
 render$0$bailout: function(state, env0, env1) {
  switch (state) {
    case 1:
      min = env0;
      break;
      ...
      for (; $.gtB(c, min); c = $.sub(c, 1)) {
        ...
        if ($.eqB(c, $.sub(this.particleNum, 1))) this.context.moveTo$2(p.get$x(), p.get$y());
          ...
          if ($.gtB(c, $.add(min, 1))) {
            ...
            t1 = $.add(t1, $.mul($.sub(point_c.x, t1), 0.5));
            var t2 = point_a.y;
            var point_ac = $.Point2D$(t1, $.add(t2, $.mul($.sub(point_c.y, t2), 0.5)));
            t1 = point_c.x;
            t1 = $.add(t1, $.mul($.sub(point_e.x, t1), 0.5));
            var t3 = point_c.y;
            var point_ce = $.Point2D$(t1, $.add(t3, $.mul($.sub(point_e.y, t3), 0.5)));
            t1 = point_b.x;
            t1 = $.add(t1, $.mul($.sub(point_d.x, t1), 0.5));
            var t4 = point_b.y;
            var point_bd = $.Point2D$(t1, $.add(t4, $.mul($.sub(point_d.y, t4), 0.5)));
            t1 = point_d.x;
            t1 = $.add(t1, $.mul($.sub(point_f.x, t1), 0.5));
            var t5 = point_d.y;
            var point_df = $.Point2D$(t1, $.add(t5, $.mul($.sub(point_f.y, t5), 0.5)));
            var rgb = this.hexToRGB$1(p.get$color());
            this.context.beginPath$0();
            t1 = 'rgba( ' + $.S($.index(rgb, 0)) + ', ' + $.S($.index(rgb, 1)) + ', ' + $.S($.index(rgb, 2)) + ', .25 )';
            this.context.set$fillStyle(t1);
 ...
 step$0: function() {
  ...
  var min = $.sub(t1, t2);
  if ($.ltB(min, 0)) min = 0;
  if (typeof min !== 'number') return this.step$0$bailout(1, t2, min, 0);
  var c = $.sub(this.particleNum, 1);
  if (typeof c !== 'number') return this.step$0$bailout(2, c, t2, min);
  var t3 = this.gravity;
  ...
  for (; c > min; --c) {
    ...
    var nb = $.index(this.particles, 'p ' + $.S(c + 1));
    var nbB = $.index(this.particles, 'p ' + $.S(c - 1));
    if (nb == null) nb = $.Particle$(this.mouseX, this.mouseY, 0, 0, 0, 16777215);
    ...
    if (c < t7) {
      p.set$x($.sub(p.get$x(), $.mul($.sub(p.get$x(), nb.get$x()), 0.6)));
      p.set$y($.sub(p.get$y(), $.mul($.sub(p.get$y(), nb.get$y()), 0.6)));
    }
    if ($.gtB(c, $.sub(this.particleNum, t2))) p.set$radius($.add(p.get$radius(), 1.5));
    else p.set$radius($.mul(p.get$radius(), 0.85));
    if ($.gtB(p.get$y(), t5)) {
      p.set$y(t5);
    ...
    if ($.gtB(p.get$distance(), t6)) {
      ...
      var oldY = p.get$y();
      t1 = nb.get$x();
      var t8 = $.Math_cos(p.get$angle());
      if (typeof t8 !== 'number') throw $.iae(t8);
      p.set$x($.add(t1, t6 * t8));
      var t9 = nb.get$y();
      var t10 = $.Math_sin(p.get$angle());
      if (typeof t10 !== 'number') throw $.iae(t10);
      p.set$y($.add(t9, t6 * t10));
 ...
 step$0$bailout: function(state, env0, env1, env2) {
  switch (state) {
    case 1:
      t2 = env0;
      min = env1;
  ...
  switch (state) {
    ...
    case 2:
      ...
      for (; $.gtB(c, min); c = $.sub(c, 1)) {
        ...
        if ($.gtB(c, $.sub(this.particleNum, t2 * 0.5))) p.set$radius($.add(p.get$radius(), 1.5));
        else p.set$radius($.mul(p.get$radius(), 0.85));
        if ($.gtB(p.get$y(), t5)) {
          p.set$y(t5);
          p.set$ySpeed($.mul(p.get$ySpeed(), -1));
 ...
 spawnParticle$0: function() {
  ...
  var pixels = this.imgContext.getImageData$4(this.mouseX, this.mouseY, 1, 1).get$data();
  var color = this.rgbToHex$3($.index(pixels, 0), $.index(pixels, 1), $.index(pixels, 2));
  $.indexSet(this.particles, 'p ' + $.S(this.particleNum), $.Particle$(this.mouseX, this.mouseY, $.mul($.Math_cos(dir), mag), $.mul($.Math_sin(dir), mag), 0, color));
  var t1 = this.particleNum;
  var t2 = this.maxParticles;
  if ($.gtB(t1, t2)) {
 ...
 imageLoaded$1: function(event$) {
  var pattern = this.imgContext.createPattern$2(this.image, 'repeat');
  this.imgContext.set$fillStyle(pattern);
  this.imgContext.fillRect$4(0, 0, $.window().get$innerWidth(), $.window().get$innerHeight());
 },
 get$imageLoaded: function() { return new $.BoundClosure(this, 'imageLoaded$1'); },
 run$0: function() {
  this.wind = 0;
  this.mouseX = 0;
  this.mouseY = 0;
  ...
  this.imgCanvas = $._ElementFactoryProvider_Element$tag('canvas');
  t1 = $.window().get$innerWidth();
  this.imgCanvas.set$width(t1);
  t1 = $.window().get$innerHeight();
  this.imgCanvas.set$height(t1);
  this.imgContext = this.imgCanvas.getContext$1('2d');
  this.image = $._ElementFactoryProvider_Element$tag('img');
  this.image.set$src('Bitmap1.png');
  $.add$1(this.image.get$on().get$load(), this.get$imageLoaded());
  $.add$1($.document().get$on().get$mouseMove(), this.get$onDocumentMouseMove());
  $.window().setInterval$2(new $.BitmapDraw04_run_f(this), $.toInt(100.0));
  $.window().setInterval$2(new $.BitmapDraw04_run_f0(this), $.toInt(33.333333333333336));
  $.window().setInterval$2(new $.BitmapDraw04_run_f1(this), $.toInt(10.0));
 }
};

$$.Particle = {"":
 ["distance=", "midPointYB!", "midPointXB!", "midPointY!", "midPointX!", "angle=", "color?", "radius=", "ySpeed=", "xSpeed=", "y=", "x="],
 super: "Object"
};
...
$.Particle$ = function(x, y, xSpeed, ySpeed, radius, color) {
  return new $.Particle(0, 0, 0, 0, 0, 0, color, radius, ySpeed, xSpeed, y, x);
};
...
$.BitmapDraw04$ = function() {
  return new $.BitmapDraw04(null, 600, 0.97, 0.5, 100, 25, null, null, null, null, null, null, null, null, null, null);
};
...
$.$defineNativeClass('HTMLInputElement', ["width!", "value=", "src!", "pattern?", "height!"], {
 step$0: function() { return this.step.$call$0(); },
 get$on: function() {
